...
database_name = case Padrino.env
  when :development then 'recall_development'
  when :production  then 'recall_production'
  when :test        then 'recall_test'
end
...
#     sessions:
#       default:
#         database: recall_development
#         hosts:
#           - localhost:27017 
#   production:
#     sessions:
#       default:
#         database: recall_production
#         hosts:
#           - localhost:27017
#   test:
#     sessions:
